...
type ButtonProps = {}
const countries = ["🇷🇺+7 Russia", "🇦🇫 +93 Афганистан", "🇦🇱 +355 Албания ", "🇦🇩 +213 Алжир ", "🇦🇸 +1684 Американское Самоа ", "🇦🇩 +376 Андорра"]
...
const PhoneMask: React.FC<ButtonProps> = ({}) => {
    ...
    const handleChange1 = React.useCallback((event: React.ChangeEvent<HTMLSelectElement>) => {
    ...
    return <div className="MainForm">
        ...
        <div className="MainMask">
            <select className="num-select" value={value1} onChange={handleChange1} tabIndex={1}>
                {countries.map(( i) => (
